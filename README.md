...
- [Mac](https://josean.com/posts/how-to-setup-alacritty-terminal)
- WSL (use windows terminal)

## CLI Requirements: 
[Step-by-Step Guide](https://josean.com/posts/7-amazing-cli-tools)
...
Use the config by copying .config/nvim to your home folder, wait for the plugins, language servers and parsers to install with lazy.nvim, Mason and nvim-treesitter.
...
If you're on mac, like me, you can install Neovim, Meslo Nerd Font, Ripgrep and Node with homebrew.
